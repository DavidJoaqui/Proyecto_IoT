 ...
 */
class Propietario extends \GestionBundle\Entity\Propietario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'vehiculo', '' . "\0" . 'GestionBundle\\Entity\\Propietario' . "\0" . 'id', '' . "\0" . 'GestionBundle\\Entity\\Propietario' . "\0" . 'username', '' . "\0" . 'GestionBundle\\Entity\\Propietario' . "\0" . 'documento', '' . "\0" . 'GestionBundle\\Entity\\Propietario' . "\0" . 'nombres', '' . "\0" . 'GestionBundle\\Entity\\Propietario' . "\0" . 'apellidos', '' . "\0" . 'GestionBundle\\Entity\\Propietario' . "\0" . 'email', '' . "\0" . 'GestionBundle\\Entity\\Propietario' . "\0" . 'password', '' . "\0" . 'GestionBundle\\Entity\\Propietario' . "\0" . 'role', '' . "\0" . 'GestionBundle\\Entity\\Propietario' . "\0" . 'isActive', '' . "\0" . 'GestionBundle\\Entity\\Propietario' . "\0" . 'telefono', '' . "\0" . 'GestionBundle\\Entity\\Propietario' . "\0" . 'createdAt', '' . "\0" . 'GestionBundle\\Entity\\Propietario' . "\0" . 'updatedAt', '' . "\0" . 'GestionBundle\\Entity\\Propietario' . "\0" . 'salt');
        }
